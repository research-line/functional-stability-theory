...
eine niedrig komplexe Struktur, die positive Zeugenmasse erreicht.  Eine
nützliche Residualdiagnose ist
\[
\begin{aligned}
R_{\mathrm{front}}(x,t)
  = H_{\mathrm{res}}(W\mid x,F_t)
    &-K(\mathrm{BPF})\\
    &-K(\mathrm{Template})-|a_n|.
\end{aligned}
\]
...
trifft oder $R_{\mathrm{front}}\geq n^\varepsilon$ übrig lässt, dann kann
