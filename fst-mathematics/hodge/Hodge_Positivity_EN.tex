...
\begin{proposition}[K\"unneth product -- primitive product-polarization sign test]
\label{prop:kunneth}
...
\item Limited functoriality tests for finite pullback subcones and primitive K\"unneth product-polarization sign formulas; full product AP-membership is not obtained from the direct sign calculation alone (Section~\ref{sec:functoriality}).
...
Finite pullback / K\"unneth sign test & Partial, conditional & limited tests \\
...
\item \textbf{Partial functoriality checks:} The paper records partial functoriality checks rather than a full functorial theory: finite pullback is conditional on the ample-cone comparison, primitive K\"unneth products provide product-polarization sign formulas only, and finite pushforward remains open.
\end{enumerate}
