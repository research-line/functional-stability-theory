...
\hypersetup{
  pdftitle={Funktionale Stabilitaetstheorie I: Thermodynamische Stabilitaet fundamentaler Parameter},
  pdfauthor={Lukas Geiger},
  pdfsubject={Thermodynamische Stabilitaet fundamentaler Parameter in einem spieltheoretischen Rahmen},
  pdfkeywords={Spieltheorie, Entropieproduktion, Standardmodell, Fine-Tuning, Nash-Gleichgewicht, Quantenmechanik, Symmetriebrechung, Envariance, Dekohaerenz}
}
