...
\textbf{P1b: Feinstrukturkonstante ($\alpha_{EM}$):} Wir erwarten ein breites Optimierungsplateau nahe dem beobachteten Wert. Tabelle~\ref{tab:alpha_scan} best\"atigt $\mathcal{S}/\mathcal{S}_{\max} > 0{,}92$ f\"ur $0{,}5 \leq \alpha/\alpha_{\text{obs}} \leq 2{,}0$. Ein signifikanter Abfall ist erst jenseits von $\alpha/\alpha_{\text{obs}} \lesssim 0{,}5$ oder $\gtrsim 3{,}0$ zu erwarten, und zwar aufgrund des Verlusts stabiler chemischer Bindung, atomarer Stabilit\"at oder verk\"urzter stellarer Lebensdauern.
