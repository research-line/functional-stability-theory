...
\textbf{Absolute-scale gate (QUANT-III-2b).}
...
\begin{tabularx}{\textwidth}{@{}L{0.32\textwidth} c c c c Y@{}}
\toprule
...
\subsection{Ecological Steady States as Candidate Game-Theoretic Analogues}
...
FST-III delivers an integrated picture of biological organization that unfolds in three phases. Table~\ref{tab:biological-game-hierarchy} summarizes the hierarchical game and stability architecture across all levels of organization.
...
\midrule
Molecular & Amino acid residues & Dihedral angles $(\phi, \psi)$ & $-\Delta G$ (Free energy) & Nash conformation / Resolvent stability \\
...
\begin{enumerate}
    ...
    \item \textbf{Persistent PDB-Dominance Bias:} Benchmarking across next-generation architectures (AlphaFold3, Chai-1, Boltz-2, BioEmu) reveals a persistent bias towards the dominant ground-state conformation deposited in the PDB, failing to capture metamorphic fold-switching transitions~\citep{Ye2026}.
...
\end{enumerate}
Consequently, pLDDT cannot serve as an independent physical stability observable. FST-Nash frustration provides a complementary, physics-grounded game-theoretic score ($\Phi_N$) that quantifies strategic coordination failure independent of database memorization heuristics.
...
(ii)~Obtain HDX protection factors from McKnight et al.~\cite{McKnight1996} or perform HDX-MS on recombinant HP35 under native conditions (pH~7.0, 25$\,^\circ$C, $\text{D}_2\text{O}$ exchange for 10\,s to 10\,h).
...
\newblock \textit{Nature Communications}, 15, 51801.
\newblock DOI: 10.1038/s41467-024-51801-z.

\bibitem[Ye et al.(2026)]{Ye2026}
Ye, X., Porter, L.~L. \& Chakravarty, S. (2026).
...
\newblock DOI: 10.1101/2026.07.10.737860.
...
\newblock \textit{bioRxiv preprint}.
\newblock DOI: 10.1101/2026.02.19.706878.

\bibitem[Jing et al.(2024)]{JingFlow2024}
Jing, B., Corso, G., Chang, J., Barzilay, R. \& Jaakkola, T. (2024).
\newblock AlphaFlow: Autonomous Generation of Protein Conformations via Flow Matching.
\newblock \textit{arXiv preprint}, arXiv:2402.04845.

\bibitem[Jing et al.(2023)]{JingDiffusion2023}
Jing, B., Eismann, S., Soni, P.~N. \& Dror, R.~O. (2023).
\newblock EigenFold: Generative Protein Structure Prediction with Harmonic Diffusion.
