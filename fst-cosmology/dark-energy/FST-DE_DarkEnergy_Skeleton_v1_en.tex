...
A Thermodynamic Bound on the Cosmological Constant}\\[6pt]
...
\thanks{This paper is part of the Functional Stability Theory programme. The programmatic hub paper is \href{https://doi.org/10.5281/zenodo.20130499}{FST --- A Programmatic Hub (Concept-DOI 10.5281/zenodo.20130499)}. AI tools (Claude by Anthropic) were used for mathematical formalization, literature verification, and editorial refinement. All mathematical content was developed, verified, and approved by the author.}}
...
note \path{BRIDGE_TO_HU_SAWICKI.md}. We classify this as a
...
potential: the Einstein-frame potential of $R + \gamma R^2$ gravity
...
The DESI~DR2 analysis~\cite{DESI2025} (arXiv:2503.14738) reports
...
\subsection{Screening as $\Gamma$-convergent phase separation (heuristic)}\label{sec:screening-gamma}
...
% [Removed: HuntMOND2026 reference -- not independently verifiable as of March 2026.
%  The ``informational persistence'' interpretation remains speculative.]
