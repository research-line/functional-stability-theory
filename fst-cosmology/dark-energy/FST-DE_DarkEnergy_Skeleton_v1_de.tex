...
\hypersetup{
  ...
  pdftitle={Dunkle Energie als residuale Vakuum-Freie-Energie: Eine thermodynamische Schranke fuer die kosmologische Konstante},
...
Eine thermodynamische Schranke f\"ur die kosmologische Konstante}\\[6pt]
...
\thanks{Dieses Paper ist Teil des Programms Functional Stability Theory. Das programmatische Hub-Paper ist \href{https://doi.org/10.5281/zenodo.20130499}{FST --- A Programmatic Hub (Concept-DOI 10.5281/zenodo.20130499)}. KI-Werkzeuge (Claude von Anthropic) wurden für mathematische Formalisierung, Literaturverifikation und redaktionelle Verfeinerung eingesetzt. Alle mathematischen Inhalte wurden vom Autor entwickelt, verifiziert und freigegeben.}}
...
\path{BRIDGE_TO_HU_SAWICKI.md} dokumentiert. Wir klassifizieren dies als
...
\hline
DESI DR2 Kompatibilitaet & Vorlaeufig (Zielwerte muessen aktualisiert werden; siehe Bemerkung~\ref{rem:desi-comparison}) \\
...
beobachtbar zu machen, nicht nur strukturell.  Die naechste Version sollte
eine Datenoverlay-Schicht ergaenzen, die CRM-Parameter direkt auf die
spaetzeitlichen Standarddeskriptoren aktueller Surveys abbildet.

Relativ zum aktuellen CORE-Status ist die Zookeeper-Schliessung von
Riemann-$C2/MS2$ kein kosmologisches Theorem.  CRM uebernimmt nur die
RFEP-v1.8-Adapter-Normalform: Operator/Form, Defekt, Approximation, Gap und
Grenzuebergang muessen in der Dark-Energy-Domaene selbst ausgewiesen
...
\begin{itemize}
  \item \textbf{Operator/Form.} Der Flow-Zeta- bzw. RG-Operator fuer $w(z)$,
  ...
  \item \textbf{Gap.} RFEP-Fixpunktkruemmung, de-Sitter-Stabilitaet und der
        Screening-Viability-Margin.
  \item \textbf{Grenzuebergang.} Background-only-Fits $\to$
...
Das naechste technische Ziel ist konkret eine CRM-to-CPL-Abbildung
\[
  \Theta_{\mathrm{CRM}}
  \longmapsto
  (w_0,w_a,H_0^{\mathrm{eff}},\Omega_m,\Omega_{\mathrm{DE}}),
\]
gefolgt von einer Vergleichstabelle fuer DESI-DR2-Kombinationen
...
BBN-Schutz des Schallhorizonts und der Cassini-Schranke fuer
...
CRM-Parameterfenster identifizieren, das zugleich die DESI-DR2-Praeferenz
fuer dynamische Dunkle Energie trifft, mit dem lokalen $H_0$-Dreieck
