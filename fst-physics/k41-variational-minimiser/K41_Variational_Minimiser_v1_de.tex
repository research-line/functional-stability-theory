...
\begin{enumerate}
  ...
  \item Der Minimierer ist nicht-entartet, wobei die Hesse-Matrix eine
        ...
        Kaskadentendenz vereinbar ist.
  \item Relaxierte Flussbedingungen und die Minimax-Notation werden als
        Leitplanken des Geltungsbereichs festgehalten: Solange das exakte
...
\end{enumerate}
Die dynamischen Konsequenzen der Variationsstruktur, einschließlich
...
Unsere Variationsperspektive schließt an neuere Entwicklungen in der Informationsthermodynamik und der variationellen Strömungsmechanik an und ergänzt diese. Insbesondere etablierte Tanogami~\cite{Tanogami2023,Tanogami2025} eine informationsthermodynamische Schranke für Energiekaskaden unter Verwendung der Kullback--Leibler-Divergenz und wies die Skalenlokalität des Informationsflusses in Schalenmodellen nach. Darüber hinaus unterstreichen moderne Variationsprinzipien für die Kolmogorov-Skalierung --- wie das stochastische Schrödinger--Bridge-Framework von Sanchis-Agudo und Vinuesa~\cite{SanchisAgudoVinuesa2025}, die adaptive fraktionale Operator-Formulierung von L\'opez~\cite{Lopez2026}, Onsagers $L^2$-Dissipationsprinzip bei Said~\cite{Said2025} sowie das spektrale Cutoff-Dissipationsmodell von Mishra~\cite{Mishra2026} --- die zentrale Bedeutung variationeller Extremalprinzipien in der Turbulenztheorie. Zudem verdeutlichen Polarisations-Geometrie-Frameworks von Skalidis~\cite{Skalidis2026}, wie geometrische Zustandsübergänge die spektrale Skalierung in turbulenten Kaskaden steuern. Mathematisch ist die Einschränkung auf zulässige Vergleichsklassen essenziell, um unphysikalische Zustände auszuschließen, wie sie in Nichteindeutigkeitstheorien schwacher Navier--Stokes-Lösungen auftreten~\cite{BuckmasterVicol2019,Isett2018}.
...
satzförmige Kernaussage des Beitrags von diagnostischen und offenen
...
Numerik, Intermittenz und DNS nur unterstützende Ebenen oder zukünftige
Prüfkriterien sind.
...
\hline
Synthetische Numerik & Sechs Modellspektren und $300$ zufällige Perturbationstests aus \texttt{compute\_F\_spectrum.py}. & Illustration und Prüfspur; keine unabhängige empirische Validierung. \\
\hline
...
\hline
\end{tabular}
\caption{Claim-Status-Ledger für den K41-Variationsminimierer-Beitrag.}
...
Leitplanken des Geltungsbereichs und eine formale Penalty-Darstellung fest, nicht
...
= \mathbf{E}^*$. Die Verwendung der relativen Entropie zur Quantifizierung von Kaskadenabweichungen zwischen den Skalen ist durch Tanogami~\cite{Tanogami2023,Tanogami2025} informationsthermodynamisch begründet.
\end{remark}
...
Innerhalb des reduzierten skalenlokalen Schalenansatzes für den Trägheitsbereich, in dem
...
Proposition~\ref{prop:A2-derived} trennt den reduzierten
Schalenansatz für den Trägheitsbereich als Dimensionsansatz von den
wirklich variablen Annahmen Lokalität und
...
abwärtsgerichteten Kaskadentendenz vereinbar ist; für sich allein definiert
...
Konstantfluss-Penalty-Buchhaltungslemma, das dieser Beitrag verwendet.
\end{proof}
...
Die Prüfansicht in Tabelle~\ref{tab:numerical-diagnostics} macht die
...
strikten K41-Steigungskriterium; thermische und warme Randrichtungen liegen
...
\hline
\textbf{Synthetisches Spektrum} & \textbf{$\mathcal{F}[E]$} & \textbf{Prüfstatus} & \textbf{Diagnostische Lesart} \\
\hline
...
\hline
\end{tabular}
\caption{Synthetische Freie-Energie- und Prüfdiagnostik aus \texttt{compute\_F\_spectrum.py}.}
...
\begin{enumerate}
\item \textbf{Statische Auswahl.}\; Theorem~\ref{thm:K41} etabliert K41 als eindeutigen variationellen Minimierer, adressiert jedoch nicht die dynamische Frage, ob die Navier--Stokes-Entwicklung das Spektrum auf diesen Minimierer zutreibt. Die dynamischen Aspekte --- einschließlich $\mathcal{F}$-Monotonie entlang Trajektorien und anomaler Dissipation --- erfordern zusätzliche Hypothesen zur nichtlinearen Kaskade und werden im Begleitbeitrag~\cite{Geiger2026b} behandelt.
...
\begin{center}
\small
\begin{tabular}{|p{0.48\textwidth}|p{0.20\textwidth}|p{0.20\textwidth}|}
\hline
...
Kanonischer Flussvorfaktor im reduzierten Schalenansatz für den Trägheitsbereich & Proposition & Prop.~\ref{prop:A2-derived} \\
\hline
\multicolumn{3}{|l|}{\textit{Leitplanken des Geltungsbereichs und formale Umschreibungen:}} \\
\hline
...
Ann.\ Math.\ \textbf{189} (2019), 101--144.
...
Ann.\ Math.\ \textbf{188} (2018), 871--963.
...
\bibitem{Lopez2026}
J.\,I.\,H.~L\'opez,
\emph{Critical Reynolds Number as a Topological Phase Transition in Adaptive Fractional Hydrodynamics},
preprint arXiv:2602.10912 (2026).
\href{https://doi.org/10.48550/arXiv.2602.10912}{doi:10.48550/arXiv.2602.10912}.

\bibitem{Mishra2026}
R.~Mishra,
\emph{Spectral Reconstruction for Under-Resolved Turbulence Measurements Using a Variational Cutoff Dissipation Model},
AIAA J.\ (2026), preprint arXiv:2512.20676.
\href{https://doi.org/10.48550/arXiv.2512.20676}{doi:10.48550/arXiv.2512.20676}.
...
\bibitem{Said2025}
H.\,A.~Said,
\emph{Application of Onsager's Variational Principle to the Navier-Stokes Equations},
preprint arXiv:2509.24033 (2025).
\href{https://doi.org/10.48550/arXiv.2509.24033}{doi:10.48550/arXiv.2509.24033}.

\bibitem{SanchisAgudoVinuesa2025}
M.~Sanchis-Agudo and R.~Vinuesa,
\emph{A Geometric Foundation for the Universal Laws of Turbulence},
preprint arXiv:2512.00068 (2025).
\href{https://doi.org/10.48550/arXiv.2512.00068}{doi:10.48550/arXiv.2512.00068}.
...
\bibitem{Skalidis2026}
R.~Skalidis,
\emph{Polarization geometry of magnetohydrodynamic turbulence},
preprint arXiv:2607.15347 (2026).
\href{https://doi.org/10.48550/arXiv.2607.15347}{doi:10.48550/arXiv.2607.15347}.

\bibitem{Tanogami2023}
T.~Tanogami,
\emph{Information-Thermodynamic Bound on Information Flow in Turbulent Cascade},
Phys.\ Rev.\ Lett.\ \textbf{130} (2023), 064001.
\href{https://doi.org/10.1103/PhysRevLett.130.064001}{doi:10.1103/PhysRevLett.130.064001}.

\bibitem{Tanogami2025}
T.~Tanogami,
\emph{Scale locality of information flow in shell models of turbulence},
J.\ Stat.\ Mech.\ (2025), 093201.
\href{https://doi.org/10.1088/1742-5468/ad6e7c}{doi:10.1088/1742-5468/ad6e7c}.
