...
\thanks{KI-Tools (Claude von Anthropic und OpenAI Codex) wurden zur mathematischen Formalisierung, Literaturprüfung und redaktionellen Verfeinerung verwendet. Der Autor bleibt für alle mathematischen Aussagen und die abschließenden redaktionellen Entscheidungen verantwortlich.}}
...
$\mathbf{E}^*$ ist diagonal mit Einträgen $1/E_j^* > 0$, was eine
  Shell-Energie-Steifigkeit liefert, die für dyadische Schalen wie
...
\begin{enumerate}
  ...
  \item Der Minimierer ist nicht-entartet, wobei die Hesse-Matrix eine
        skalenabhängige Shell-Energie-Steifigkeit
...
Der Autor dankt KI-gestützten Systemen für die Unterstützung bei der Literaturrecherche, technischen Querprüfungen und der Manuskriptvorbereitung.
