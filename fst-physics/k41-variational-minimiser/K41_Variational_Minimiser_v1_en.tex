...
\thanks{AI tools (Claude by Anthropic and OpenAI Codex) were used for mathematical formalization, literature checks, and editorial refinement. The author remains responsible for all mathematical claims and final editorial decisions.}}
...
intermittency parameter $\mu$~\cite{K62,Frisch95}.  Under
this ansatz, the
...
The author thanks AI-assisted systems for support with literature review,
technical cross-checks, and manuscript preparation.
