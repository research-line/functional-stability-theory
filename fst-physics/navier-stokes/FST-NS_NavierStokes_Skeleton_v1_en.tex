...
\begin{itemize}
  ...
  \item \textbf{Man\'e projectors}
    (Man\'e~\cite{Mane1981}; Zelik~\cite{Zelik2022}):
...
Attractor package + Assumption G + Condition D $\Rightarrow$ regularity & Theorem (conditional) \\
...
$H^1$-obstruction (Prop.~\ref{thm:H1-main}) & Proof sketch (3 open gaps) \\
\hline
...
in: Handbook of Differential Equations: Evolutionary Equations, vol.~4 (C.~M.~Dafermos and M.~Pokorn\'y, eds.), Elsevier, 2008, pp.~505--604.
...
\bibitem{Geiger2026-LDI} L.~Geiger, \textit{Log-Distance Integrability for Dissipative Flows: BV Projections onto Fractal Attractors}, Preprint, 2026. \texttt{DOI: 10.5281/zenodo.19056808}.
